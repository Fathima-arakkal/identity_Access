...
namespace InternshipProjectMini.Controllers
{
    ...
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,FirstName,LastName,EmployeeNumber,Username,Password,Gender,DepartmentId")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,FirstName,LastName,EmployeeNumber,Username,Password,Gender,DepartmentId")] Employee employee)
        {
